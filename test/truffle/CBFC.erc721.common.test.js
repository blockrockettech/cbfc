...
contract('CBFC common ERC721 tests', function (accounts) {
  ...
  describe('like a ERC721BasicToken', function () {
    beforeEach(async function () {
      await this.token.transferCard(_defaultCardSetNumberOne, {from: _owner});
      await this.token.transferCard(_defaultCardSetNumberTwo, {from: _owner});
    });
    ...
    describe('exists', function () {
      describe('when the token exists', function () {
        it('should return true', async function () {
          const result = await this.token.exists(_defaultCardSetOneSerialNumberOne);
    ...
    describe('ownerOf', function () {
      describe('when the given token ID was tracked by this token', function () {
        it('returns the owner of the given token ID', async function () {
          const owner = await this.token.ownerOf(_defaultCardSetOneSerialNumberOne);
    ...
    describe('transfers', function () {
      ...
      const tokenId = _defaultCardSetOneSerialNumberOne;
      const data = '0x42';
      ...
      const shouldTransferTokensByUsers = function (transferFunction) {
        ...
        describe('when sent to the owner', function () {
          ...
          it('keeps same tokens by index', async function () {
            ...
            tokensListed.map(t => t.toNumber()).should.have.members([_defaultCardSetTwoSerialNumberTwo, _defaultCardSetOneSerialNumberOne]);
          });
        });
  ...
  describe('like a mintable and burnable ERC721Token', function () {
    ...
    describe('mint', function () {
      ...
      describe('when successful', function () {
        beforeEach(async function () {
          const result = await this.token.transferCard(_defaultCardSetNumberOne, {from: _owner});
          logs = result.logs;
        });
        ...
        it('emits a transfer event', async function () {
          ...
          logs[0].args._to.should.be.equal(_owner);
          // FIXME add missing

          logs[1].event.should.be.eq('CardMinted');
          logs[1].args._owner.should.be.equal(_owner);
          // FIXME add missing
        });
      });
    });
